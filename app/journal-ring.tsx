...
export default function JournalRingDetail() {
  ...
  // —— 路由参数 —— //
  const params = useLocalSearchParams<{ mode?: "boulder" | "toprope" | "lead"; date?: string; lang?: "zh" | "en" }>();
  ...
  const mode: "boulder" | "toprope" | "lead" = (params.mode as any) || "boulder";
  const logType = mode;
  const modeLabel = mode === "boulder" ? tr("抱石", "Bouldering") : mode === "toprope" ? tr("顶绳", "Top Rope") : tr("先锋", "Lead");
