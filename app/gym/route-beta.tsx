// Gym variant of /outdoor/route-beta. Renders the full beta video list
// for one gym route. Uses the same BetaCard + BetaPlayerSheet as outdoor
// since BetaOut shapes are identical between the two endpoints (only the
// route_kind discriminator differs).
...
export default function GymRouteBetaPage() {
  ...
  const fetchPage = useCallback(
    async (offset: number, replace: boolean) => {
      ...
      const data = await gymsCatalogApi.listBeta(safeRouteId, {
        limit: PAGE_SIZE,
        offset,
      });
  ...
  // Likes go through the shared /outdoor/beta/{id}/like endpoints — they
  // operate on the polymorphic RouteBeta row by id, route_kind agnostic.
